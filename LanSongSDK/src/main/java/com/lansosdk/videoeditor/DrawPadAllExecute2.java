...
public class DrawPadAllExecute2 {
    ...
    @Override public void onLanSongSDKProgress(long ptsUs, int percent) {
    //                Log.e("TAG", "------ptsUs: "+ptsUs+ " percent :"+percent);
    }
    });

     allExecute.setOnLanSongSDKCompletedListener(new OnLanSongSDKCompletedListener() {
    @Override public void onLanSongSDKCompleted(String dstVideo) {
    ...
    @Override public void onDrawCanvas(CanvasLayer layer, Canvas canvas, long currentTimeUs) {
