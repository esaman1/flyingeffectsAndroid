 ...
 */
public class AlbumActivityForCreateVideo extends BaseActivity implements
    ...
    private int createView() {
        switch (mWidget.getUiStyle()) {
            ...
            case Widget.STYLE_LIGHT: {
                return R.layout.album_activity_album_creat_video_light;
            }
            default: {
    ...
    private Action<String> mCameraAction = new Action<String>() {
        ...
        public void onAction(@NonNull String result) {
            ...
            PathConvertTask task = new PathConvertTask(conversion, AlbumActivityForCreateVideo.this);
            task.execute(result);
        }
    };
