 ...
 * describe:消息页面
 **/
public class Like_adapter extends BaseQuickAdapter<systemessagelist, BaseViewHolder> {

    private Context context;
    public final static String TAG = "main_recycler_adapter";

    public Like_adapter(int layoutResId, @Nullable List<systemessagelist> allData, Context context) {
