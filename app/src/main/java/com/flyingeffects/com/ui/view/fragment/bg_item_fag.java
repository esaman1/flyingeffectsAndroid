...
import com.flyingeffects.com.ui.presenter.bg_itemMvpPresenter;
...
public class bg_item_fag extends BaseFragment implements BjItemMvpView,View.OnClickListener {

    private bg_itemMvpPresenter Presenter;
    ...
    protected void initView() {
        ...
        Presenter = new bg_itemMvpPresenter(getActivity(), this,fromType);
        initRecycler();
