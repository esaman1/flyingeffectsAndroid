...
public class long_movie_adapter extends BaseQuickAdapter<starEnity, BaseViewHolder> {

    private Context context;
    public final static String TAG = "RecyclerView2List";


    public long_movie_adapter(int layoutResId, @Nullable List<starEnity> data, Context context) {
