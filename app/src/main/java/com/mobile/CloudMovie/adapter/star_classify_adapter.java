...
public class star_classify_adapter extends BaseQuickAdapter<starEnity, BaseViewHolder> {

    private Context context;
    public final static String TAG = "RecyclerView2List";


    public star_classify_adapter(int layoutResId, @Nullable List<starEnity> data, Context context) {
