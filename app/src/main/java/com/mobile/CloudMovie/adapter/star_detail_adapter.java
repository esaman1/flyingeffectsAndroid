...
public class star_detail_adapter extends BaseQuickAdapter<starEnity, BaseViewHolder> {

    private Context context;
    public final static String TAG = "RecyclerView2List";


    public star_detail_adapter(int layoutResId, @Nullable List<starEnity> data, Context context) {
