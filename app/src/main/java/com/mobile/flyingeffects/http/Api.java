...
import com.mobile.flyingeffects.base.BaseApplication;
import com.mobile.flyingeffects.manager.SPHelper;
import com.mobile.flyingeffects.utils.DESUtil;
import com.mobile.flyingeffects.utils.RSAUtil;
    ...
    static class HttpHeadInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            if (!abc.isEncryption) {
                ...
                builder.addHeader("stoken", "EUMHJlupWwOVBeoXIdiaaH7Y2r8QaGN09sP2VrEdcjc");
                builder.addHeader("secret", "aWsJiYPsUePHZZyTcDwmNzTyaVgSxvhu");
