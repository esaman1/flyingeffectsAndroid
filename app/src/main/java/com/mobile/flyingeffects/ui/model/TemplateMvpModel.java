...
import com.mobile.flyingeffects.commonlyModel.DoubleClick;
import com.mobile.flyingeffects.commonlyModel.SaveAlbumPathModel;
        ...
        public void renderVideo(String  mTemplateFolder,String mAudio1Path){
            Observable.create((Observable.OnSubscribe<Boolean>) subscriber -> {
                ...
                SXTemplateRender sxTemplateRender;
                 String outputPathForVideoSaveToPhoto = SaveAlbumPathModel.getInstance().getKeepOutput();
            ...
            }).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(this::renderFinish);

        }



    private void renderFinish(boolean isSucceed) {
