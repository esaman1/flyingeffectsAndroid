package com.sweet.paylib.alipay;
...
import com.sweet.paylib.interfaces.OnRequestListener;
...
public class AliPayManager {
    ...
    public static void aliPay(final Activity activity, String appid, boolean isRsa2, String alipay_rsa_private, AliPayModel aliPayModel, OnRequestListener onRequestListener) {
        ...
        Map<String, String> params = AliPayOrderInfoUtil2_0.buildOrderParamMap(appid, isRsa2, aliPayModel);
        String orderParam = AliPayOrderInfoUtil2_0.buildOrderParam(params);

        String privateKey = alipay_rsa_private;

        String sign = AliPayOrderInfoUtil2_0.getSign(params, privateKey, isRsa2);
