...
public class AssetModel {
    ...
    public AssetModel(String folder, JSONObject asset, AssetDelegate delegate, float uiVersionMajor,Size temSize,float fps ,int nowTemplateIsAnim,boolean isToSing) throws JSONException {
        ...
        if (type == TYPE_TEXT) {
            ...
            if (uiVersionMajor > 1) {
                this.ui = new MediaUiModel2(folder, ui, mBitmap, delegate, size,temSize,fps,nowTemplateIsAnim,isToSing);
            } else {
